...
it("show isLoggedIn false language is ja", () => {
  render(<Header currentUrlPath="/" isLoggedIn={false} language="ja" />);
...
it("show isLoggedIn false language is en", () => {
  render(<Header currentUrlPath="/" isLoggedIn={false} language="en" />);
...
it("show isLoggedIn true language is ja", () => {
  ...
  render(<Header currentUrlPath="/" isLoggedIn={true} language="ja" />);
...
it("show isLoggedIn true language is en", () => {
  // eslint-disable-next-line react/prefer-shorthand-boolean
  render(<Header currentUrlPath="/" isLoggedIn={true} language="en" />);

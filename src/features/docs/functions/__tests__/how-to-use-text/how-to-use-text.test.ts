...
const testBaseUrl = "https://lgtmeow.com" as Url;
...
describe("src/features/docs/functions/how-to-use-text.ts getHowToUseTexts TestCases", () => {
  ...
  `(
    ...
    ({
      ...
      const result = getHowToUseTexts(language, testBaseUrl);
  ...
  it("should return Japanese texts with correct structure when language is ja", () => {
    const result = getHowToUseTexts("ja", testBaseUrl);
  ...
  it("should return English texts with correct structure when language is en", () => {
    const result = getHowToUseTexts("en", testBaseUrl);
  ...
  it("should include correct URLs when custom baseUrl is passed", () => {
    const customBaseUrl = "https://custom-domain.com" as Url;

    const result = getHowToUseTexts("ja", customBaseUrl);
  ...
  it("should use lgtmeow.com URLs when baseUrl is lgtmeow.com", () => {
    const result = getHowToUseTexts("ja", testBaseUrl);
